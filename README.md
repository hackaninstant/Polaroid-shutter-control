...
If you don't want to retain auto exposure, you can simple connect the wires according to the PolaroidShutter schematic diagram. Auto exposure will not work. The wire coming from the Polaroid shutter circuit is not used do doesn't need to be connected. Be sure to ground the shutter circuit on the ribbon cable. 

If you want to be able to switch between auto and manual shutter control, you will need a DPDT and an SPDT switch and wire the arduino/camera using the Polariod integration schematic and 3 poles of the switches.
